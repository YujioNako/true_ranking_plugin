...
export async function loadYunzaiPlugin() {
  ...
  await fs.writeFile(file,source+'\nexport {runtime,delay,RequestError,newCheckpoint,validateCheckpoint,checkpointStore,progressText,CONFIG,parseCommand,parseTarget,loadCookie,createClient,collectReviews,analyze,summarize,filterRows,trend,probability,buildPanelHtml,buildTextResult,renderPanel};\n');
